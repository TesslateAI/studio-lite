            ...
            <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
              ...
              <div className="text-center md:text-left">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl tracking-tight mb-6">
                  <span className="font-medium">Experience Models </span>
                  <br className="hidden xs:inline sm:hidden md:inline" />
                  That <span className="font-medium text-orange-500">Understand UI</span>
                </h1>
              ...
              {/* Demo Section Column */}
              <div className="mt-10 md:mt-0 mx-auto max-w-2xl md:max-w-none w-full">
