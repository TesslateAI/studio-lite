...
export function EnterpriseCard() {
    return (
        <div className="pt-6 border rounded-xl p-8 bg-white relative flex flex-col h-full">
            ...
            <ul className="space-y-4 mb-8 flex-grow">
                <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Host Tesslate's models on your own infrastructure</span>
                </li>
                <li className="flex items-start">
                    <Check className="h-5 w-5 text-black mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Private deployment & custom integrations</span>
                </li>
                <li className="flex items-start">
                    <Check className="h-5 w-5 text-black mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Designed for secure, scalable usage in enterprise settings</span>
                </li>
                <li className="flex items-start">
                    <Check className="h-5 w-5 text-black mr-2 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                    <Check className="h-5 w-5 text-black mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Custom model fine-tuning options</span>
                </li>
            </ul>
